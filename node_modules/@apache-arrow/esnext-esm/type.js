...
export class DataType {
    /** @nocollapse */ static isNull(x) { return x?.typeId === Type.Null; }
    /** @nocollapse */ static isInt(x) { return x?.typeId === Type.Int; }
    /** @nocollapse */ static isFloat(x) { return x?.typeId === Type.Float; }
    /** @nocollapse */ static isBinary(x) { return x?.typeId === Type.Binary; }
    /** @nocollapse */ static isUtf8(x) { return x?.typeId === Type.Utf8; }
    /** @nocollapse */ static isBool(x) { return x?.typeId === Type.Bool; }
    /** @nocollapse */ static isDecimal(x) { return x?.typeId === Type.Decimal; }
    /** @nocollapse */ static isDate(x) { return x?.typeId === Type.Date; }
    /** @nocollapse */ static isTime(x) { return x?.typeId === Type.Time; }
    /** @nocollapse */ static isTimestamp(x) { return x?.typeId === Type.Timestamp; }
    /** @nocollapse */ static isInterval(x) { return x?.typeId === Type.Interval; }
    /** @nocollapse */ static isList(x) { return x?.typeId === Type.List; }
    /** @nocollapse */ static isStruct(x) { return x?.typeId === Type.Struct; }
    /** @nocollapse */ static isUnion(x) { return x?.typeId === Type.Union; }
    /** @nocollapse */ static isFixedSizeBinary(x) { return x?.typeId === Type.FixedSizeBinary; }
    /** @nocollapse */ static isFixedSizeList(x) { return x?.typeId === Type.FixedSizeList; }
    /** @nocollapse */ static isMap(x) { return x?.typeId === Type.Map; }
    /** @nocollapse */ static isDictionary(x) { return x?.typeId === Type.Dictionary; }
