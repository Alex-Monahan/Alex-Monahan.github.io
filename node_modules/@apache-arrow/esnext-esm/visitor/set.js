...
/** @ignore */ const _setStructArrayValue = (o, v) => (c, _, i) => c?.set(o, v[i]);
/** @ignore */ const _setStructVectorValue = (o, v) => (c, _, i) => c?.set(o, v.get(i));
/** @ignore */ const _setStructMapValue = (o, v) => (c, f, _) => c?.set(o, v.get(f.name));
/** @ignore */ const _setStructObjectValue = (o, v) => (c, f, _) => c?.set(o, v[f.name]);
/** @ignore */
